...
<html>
        ...
        <div class="modal-body">
             <form action="../sr_menu" method="post" class="form-group">
               <div class="form-item">
                ...
                <div class="form-item">
                        <input type="number" name="txt_nivel" id="txt_nivel" class="form-control" placeholder="Nivel" required>  
                </div>
                <div class="form-item">
                    <select name="drop_puesto" id="drop_puesto" class="form-control">
                        <option class="default">Hijo de</option>
                        <% 
                            menu menu_drop = new menu();
                            HashMap<String,String> drop = menu_drop.drop_sangre();
                 ...
                 <div class="form-item">
                    <input type="text" name="txt_url" id="txt_url" class="form-control" placeholder="URL: /servicios.jsp" required>
                 </div>
                 <br>
  ...
  <table class="table table-striped">
    ...
    <tbody id="tbl_empleados">
        <% 
        menu Menu = new menu();
        DefaultTableModel tabla_mostrar = new DefaultTableModel();
        tabla_mostrar = Menu.leer();
        for (int t=0;t<tabla_mostrar.getRowCount();t++){
            out.println("<tr data-id=" + tabla_mostrar.getValueAt(t,0) + " data-id_p=" + tabla_mostrar.getValueAt(t,3) + ">");
            out.println("<td>" + tabla_mostrar.getValueAt(t,0) + "</td>");
            out.println("<td>" + tabla_mostrar.getValueAt(t,1) + "</td>");
            out.println("<td>" + tabla_mostrar.getValueAt(t,2) + "</td>");
            out.println("<td>" + tabla_mostrar.getValueAt(t,4) + "</td>");
            out.println("</tr>");
