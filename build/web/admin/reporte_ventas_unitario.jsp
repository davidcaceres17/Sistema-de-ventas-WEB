...
<html>
    ...
    <body class="mantenimiento-empleados">
        ...
        for (int t=0;t<tabla_empleados.getRowCount();t++){
            out.println("<thead>");
            out.println("<th><strong>No. Factura: </strong>" + tabla_empleados.getValueAt(t,1) + "</th>");
            out.println("<th><strong>Serie: </strong> " + tabla_empleados.getValueAt(t,2) + "</th>");
            out.println("<th>" + tabla_empleados.getValueAt(t,7) + "</th>");
            out.println("</thead>");
            out.println("<tbody>");
            out.println("<tr>");
            out.println("<td><strong>Cliente: </strong>" + tabla_empleados.getValueAt(t,3) + "</td>");
            out.println("<td><strong>Empleado: </strong>" + tabla_empleados.getValueAt(t,5) + "</td>");
            out.println("<td></td>");
            out.println("</tr>");
        ...
        out.println("<td><strong>Precio</strong></td>");
        out.println("</tr>");
        ...
        for (int t2=0;t2<tabla_ventas_detalle.getRowCount();t2++){
            out.println("<tr class='tr-productos'>");
            out.println("<td>" + tabla_ventas_detalle.getValueAt(t2,1) + "</td>");
            out.println("<td class='td-cantidad'>" + tabla_ventas_detalle.getValueAt(t2,4) + "</td>");
            out.println("<td class='td-precio'>Q<span>" + tabla_ventas_detalle.getValueAt(t2,5) + "</span></td>");
