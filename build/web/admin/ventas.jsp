            ...
            <div class="row">
             ...
             <form action="../sr_venta" method="post" class="form-group">
               <label for="lbl_id" ><b>ID</b></label>
                ...
                <select name="idcliente" id="drop_puesto" class="form-control">
                    <% 
                ...
                <select name="idempelado" id="drop_puesto" class="form-control">
                    <% 
                        Empleado empleado = new Empleado();
                        HashMap<String,String> drop2 = empleado.drop_sangre();
