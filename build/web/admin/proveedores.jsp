...
<html>
    ...
    <body class="mantenimiento-proveedores">
        <header>
            <div class="row">
  ...
  <table class="table table-striped">
    ...
    <tbody id="tbl_empleados">
        ...
        tabla_proveedores = proveedores.leer();
        for (int t=0;t<tabla_proveedores.getRowCount();t++){
            out.println("<tr data-id=" + tabla_proveedores.getValueAt(t,0) + ">");
            out.println("<td>" + tabla_proveedores.getValueAt(t,0) + "</td>");
            out.println("<td>" + tabla_proveedores.getValueAt(t,1) + "</td>");
            out.println("<td>" + tabla_proveedores.getValueAt(t,2) + "</td>");
            out.println("<td>" + tabla_proveedores.getValueAt(t,3) + "</td>");
            out.println("<td>" + tabla_proveedores.getValueAt(t,4) + "</td>");
            out.println("</tr>");
