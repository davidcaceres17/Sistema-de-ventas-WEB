...
<html>
  ...
  <table class="table table-striped">
    ...
    <tbody id="tbl_empleados">
        ...
        DefaultTableModel tabla_marcas = new DefaultTableModel();
        tabla_marcas = marcas.leer();
        for (int t=0;t<tabla_marcas.getRowCount();t++){
            out.println("<tr data-id=" + tabla_marcas.getValueAt(t,0) + ">");
            out.println("<td>" + tabla_marcas.getValueAt(t,0) + "</td>");
            out.println("<td>" + tabla_marcas.getValueAt(t,1) + "</td>");
            out.println("</tr>");
