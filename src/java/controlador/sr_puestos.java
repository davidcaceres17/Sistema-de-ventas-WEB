 ...
 * @author justo
 */
@WebServlet(name = "sr_puestos", urlPatterns = {"/sr_puestos"})
public class sr_puestos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet sr_puestos</title>");            
            out.println("</head>");
            out.println("<body>");
            puesto = new Puesto(Integer.valueOf(request.getParameter("txt_id")),request.getParameter("puesto"));
            // Boton agregar 
            if ("agregar".equals(request.getParameter("btn_agregar"))){
             ...
             out.println("<a href='./admin/puestos.jsp'>Regresar...</a>");
             }
             }
